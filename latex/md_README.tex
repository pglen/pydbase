...
The pytest passes with no errors; The following test are created / executed\+: \begin{DoxyVerb}    test_bindata.py .                     [  7%]
    test_create.py .....                  [ 46%]
    test_del.py .                         [ 53%]
    test_dump.py .                        [ 61%]
    test_packer.py ..                     [ 76%]
    ...
    test_vacuum.py .                      [100%]
\end{DoxyVerb}
 \hypertarget{md_README_autotoc_md10}{}\doxysection{Maintenance}\label{md_README_autotoc_md10}
...
Note about the \textquotesingle{}garbage\textquotesingle{} directory ... older stuff I tried; some are really useful; For instance take a look at the simplifier\+: an array of indexes to save offsets and lengths; The simplifier makes one range out of overlapping or close to each other ranges. (min. dist=4)\hypertarget{md_README_autotoc_md11}{}\doxysubsection{TODO}\label{md_README_autotoc_md11}
